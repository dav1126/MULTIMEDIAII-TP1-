System.register(['angular2/core', 'angular2/router', './hero.service'], function(exports_1, context_1) {
    ...
    var core_1, router_1, router_2, hero_service_1;
    ...
    return {
        ...
        execute: function() {
            HeroDetailComponent = (function () {
                function HeroDetailComponent(_heroService, _routeParams, router) {
                ...
                HeroDetailComponent.prototype.deleteThisHero = function () {
                    var id = +this._routeParams.get('id');
                ...
                HeroDetailComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [hero_service_1.HeroService, router_1.RouteParams, router_2.Router])
                ], HeroDetailComponent);
